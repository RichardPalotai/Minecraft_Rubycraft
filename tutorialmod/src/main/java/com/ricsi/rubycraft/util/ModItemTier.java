...
class RicskoModItemTier implements IItemTier // Itt latod, hogy a RicskoModItemTier osztaly implementalja ay IItemTier interfeszt
{
    ...
    private static Supplier<Ingredient> createIngredientSupplier(Item item) {
        ...
        return ()->{ return Ingredient.fromItems( item ); };
    }
